module ReadingsHelper
  ...
  def zodiac_picker_for member, birthday
    if member.nil?
      link_to(birthday.zodiac_for_birthday.leader.capitalize, personality_for_zodiac_birthday_path(birthday, :zodiac_sign => birthday.zodiac_for_birthday.leader, :source_cards => true), :remote => true, :class => 'zodiac_selection') +
      link_to(birthday.zodiac_for_birthday.follower.capitalize, personality_for_zodiac_birthday_path(birthday, :zodiac_sign => birthday.zodiac_for_birthday.follower, :source_cards => true), :remote => true, :class => 'zodiac_selection')
